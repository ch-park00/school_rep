%%
function [phi, theta, psi]=ComFilterWithPI(p,q,r,ax,ay,az,dt)
...
[dotPhi,dotTheta,dotPsi]=BodyToIntertial(p,q,r,prevPhi,prevTheta);
...
function [dotPhi,dotTheta,dotPsi]=BodyToIntertial(p,q,r,phi,theta)
